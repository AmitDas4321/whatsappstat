...
function printToFile() {
    document.getElementById("foot-cont").innerHTML = '<div class="flow-text" style="margin-top:30px">Generated Using WhatsApp Stat <div style="color:teal">www.amitdas.site/whatsappstat</div></div>';
